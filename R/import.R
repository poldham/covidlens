...
#' @description Import csv files downloaded from the Lens COVID collection of scientific or patent literature. If patent data specify patent in the type. Otherwise
#'   leave as is.
...
import <- function(path, type = NULL){
  ...
  # to do. remove need to have tidyverse loaded by naming pkgs in function
